...
2. 優先：
   ...
   - 航空產業重大趨勢
   - 對航空業可能有長期影響的事件
3. 一般性、瑣碎性、純促銷、純廣告、價值較低的新聞可以排除。
4. 不需要平均分配媒體來源。
5. 同一來源最多可以選 4 篇，但只有在該來源確實有多篇高價值新聞時才選到 4 篇。
6. 如果某一來源有很多非常重要的新聞，可以選 3～4 篇。
7. 不要為了湊來源多樣性而選擇明顯較差的新聞。
8. 如果高品質新聞主要集中在少數來源，可以讓這些來源佔較多篇數。
9. 最多 8 篇，不足 8 篇時不要硬湊。
